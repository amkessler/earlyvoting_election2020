...
*(Note this designation is based on a statistical model by Catalist, it is not taken from state voting registrations themselves.)*
...
Here below is an expanded table showing the particulars behind those percent changes around Black, Hispanic and Caucasion early voters.
